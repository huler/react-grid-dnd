...
Install `@mcg/react-grid-dnd-but-better` and `react-gesture-responder` using yarn or npm.

  

```

yarn add @mcg/react-grid-dnd-but-better react-gesture-responder
...
yarn add @mcg/react-grid-dnd-but-better

yarn link "@mcg/react-grid-dnd-but-better"
